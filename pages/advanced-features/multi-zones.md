...
- Make sure to configure a [basePath](/api-reference/next.config.js/basepath) to avoid conflicts with pages and static files.

## How to merge zones

You can merge zones using [`rewrites`](/api-reference/next.config.js/rewrites) in one of the apps or any HTTP proxy.
