...
To improve the security of your application, you can use [`headers`](/api-reference/next.config.js/headers) in `next.config.js` to apply HTTP response headers to all routes in your application.
