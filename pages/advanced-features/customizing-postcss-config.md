...
Next.js compiles CSS for its [built-in CSS support](/basic-features/built-in-css-support) using PostCSS.
...
You can learn more about [Next.js' CSS Module support here](/basic-features/built-in-css-support).
