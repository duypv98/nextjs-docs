...
[Learn more about streaming in Next.js](/advanced-features/react-18/streaming).
...
Server Components are still in research and development. [Learn how to try Server Components](/advanced-features/react-18/server-components) as an experimental feature in Next.js.

## Switchable Runtime (Alpha)

Next.js supports changing the runtime of your application between Node.js and the [Edge Runtime](/api-reference/edge-runtime) at the page level. For example, you can selectively configure specific pages to be server-side rendered in the Edge Runtime.

This feature is still experimental. [Learn more about the switchable runtime](/advanced-features/react-18/switchable-runtime).
