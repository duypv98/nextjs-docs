...
The Next.js Edge Runtime is based on standard Web APIs, which is used by [Middleware](/middleware) and [Edge API Routes](/api-routes/edge-api-routes).
...
You can use `process.env` to access [Environment Variables](/basic-features/environment-variables) for both `next dev` and `next build`.
...
<div class="card">
  <a href="/advanced-features/middleware">
    <b>Middleware</b>
