...
> Since the release of [Next.js 9.4](https://nextjs.org/blog/next-9-4) we now have a more intuitive and ergonomic experience for [adding environment variables](/basic-features/environment-variables). Give it a try!
...
<div class="card">
  <a href="/basic-features/environment-variables">
