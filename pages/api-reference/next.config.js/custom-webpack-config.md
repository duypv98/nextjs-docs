...
- [CSS imports](/basic-features/built-in-css-support#adding-a-global-stylesheet)
- [CSS modules](/basic-features/built-in-css-support#adding-component-level-css)
- [Sass/SCSS imports](/basic-features/built-in-css-support#sass-support)
- [Sass/SCSS modules](/basic-features/built-in-css-support#sass-support)
- [preact](https://github.com/vercel/next.js/tree/canary/examples/using-preact)
- [Customizing babel configuration](/advanced-features/customizing-babel-config)
