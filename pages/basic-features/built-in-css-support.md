...
Create a [`pages/_app.js` file](/advanced-features/custom-app) if not already present.
...
Due to the global nature of stylesheets, and to avoid conflicts, you may **only import them inside [`pages/_app.js`](/advanced-features/custom-app)**.
...
<div class="card">
  <a href="/advanced-features/customizing-postcss-config">
