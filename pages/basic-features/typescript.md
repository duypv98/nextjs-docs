...
If you want to silence the error reports, refer to the documentation for [Ignoring TypeScript errors](/api-reference/next.config.js/ignoring-typescript-errors).
...
> If you're using `getInitialProps`, you can [follow the directions on this page](/api-reference/data-fetching/get-initial-props#typescript).
...
If you have a [custom `App`](/advanced-features/custom-app), you can use the built-in type `AppProps` and change file name to `./pages/_app.tsx` like so:
...
You can learn more about this feature on the [Module Path aliases documentation](/advanced-features/module-path-aliases).
